...
1. **Add library code** to `library/src/main/java/es/joshluq/canvaskit/`
2. **Write unit tests** in `library/src/test/java/es/joshluq/canvaskit/`
3. **Write instrumented tests** in `library/src/androidTest/java/es/joshluq/canvaskit/`
4. **Integrate the library** in the showcase app at `showcase/src/main/java/es.joshluq.canvaskit/showcase/` to validate the consumer experience
5. **Add showcase tests** in `showcase/src/test/java/es.joshluq.canvaskit/showcase/` or `showcase/src/androidTest/java/es.joshluq.canvaskit/showcase/`
